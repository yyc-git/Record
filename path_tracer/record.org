...
q:
direction to sphere to uv coordinate, not + 0.5???
...
** TODO finish path tracer edu cource!




** TODO publish new cource: multplie lights(direct light sample); mis; ibl;




** TODO add camera adapter get from fly camera
...
** TODO publish new cource: MLT, Manifold Exploration
...
** TODO publish new cource: 微表面; bsdf;

** TODO publish new cource: volumn scattering
...
** TODO publish new cource: disney brdf/bsdf





** TODO open source(only has rtx pipeline, not need webgpu+compute shader pipeline!)
