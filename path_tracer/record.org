...
** TODO add bsdf material(only Transmittance)
...
*** TODO change brdf material to bsdf material
...
add gltf to wdd converter


////directly load gltf and build scene graph!

support extensions:
KHR_materials_transmission(to support bsdf)
...
*** TODO support KHR_materials_transmission and KHR_materials_ior
